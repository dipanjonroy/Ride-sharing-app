...
import "../CSS/VehicleDescription.css";
import { Link } from "react-router-dom";

function VehicleDescription({closePanel}) {
  return (
    <div className="v-description-panel bg-light p-4 text-dark d-flex flex-column justify-content-center align-items-center">
      ...
      <h3 className="mt-4">Looking for nearby drivers</h3>
      <img
      ...
      <Link className="w-100 rounded mt-4">Confirm</Link>
    </div>
  );
}
