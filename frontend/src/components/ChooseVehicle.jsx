...
function ChooseVehicle() {
  return (
    <div className="overflow-auto">
      <div className="vehicle d-flex align-items-center justify-content-between text-dark">
        <img
